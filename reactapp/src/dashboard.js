...
import dashboard from './dashboard'
  ...
  function Navie() {
      return (
        ...
        <li><Link to='appointment'>Books</Link></li>
        ...
        <div class="dropdown">
  <button class="dropbtn">Book Reviews</button>
  <div class="dropdown-content">
  <Link to="./physical">Fiction</Link>
  <Link to="./software">Mystery</Link>
  <Link to="./status">Fantasy</Link>
  </div>
</div>
        ...
        <section className="hero-section">
          <h1 className="hero-title">Do What Your Mind Tells</h1>
          <p className="hero-subtitle"></p>
          <button className="cta-button">BOOKIFY.COM</button>
        </section>

        <section className="services-section">
          <h2 className="section-title">Our Services</h2>
          <div className="service-card">
            <img src={books1} alt="Car Insurance" />
            <h3 className="service-title">My Subscription</h3>
            <p className="service-description">Individuals and institutions can subscribe to The Book Review through this secure on-line payment facility. Subscribers can choose between the options listed below

Print Edition plus Web Edition ( Individual- Rs. 3000, Institution- Rs. 5000 for India only)
Web Edition (Individual Rs. 1500, Institution Rs. 2500 for India only)
Print Edition</p>
          </div>
          <div className="service-card">
            <img src={books2} alt="Home Insurance" />
            <h3 className="service-title">Review New Books </h3>
            <p className="service-description">A book review is a form of literary criticism in which a book is merely described (summary review) or analyzed based on content, style, and merit. A book review may be a primary source, opinion piece, summary review or scholarly review. Books can be reviewed for printed periodicals, magazines and newspapers, as school work, or for book websites on the Internet. A book review's length may vary from a single paragraph to a substantial essay.
            </p>
          </div>
          <div className="service-card">
            <img src={books3} alt="Life Insurance" />
            <h3 className="service-title">Prime Users</h3>
            <p className="service-description">Bookify reading services, such as Prime Reading, Amazon Original Stories, and Amazon First Reads, allow customers to discover new books and authors—at no additional cost to their Prime membership.Literary trend setters can gain access to titles before they publish with Amazon First Reads, a Prime member reading benefit that offers early access to a selection of new books one month before they officially publish.</p>
            </div>
</section>
</main>
        <br></br>
        ...
        <div class="footer">
      <div class="heading">
        <h2>Bookify<sup>™</sup></h2>
      </div>
      <div class="content">
        <div class="services">
          <h4>Services</h4>
          <p><a href="#">My Subscription</a></p>
          <p><a href="#">Review new books</a></p>
          <p><Link to="./BookAppointment">Prime users</Link></p>
        </div>
        <div class="social-media">
          ...
          <p>
            <a href="https://github.com/iklas60"
              ><i class="fab fa-github"></i> Github</a>
          </p>
          <p>
            <a href="https://www.facebook.com/iklasmobileservice"
              ><i class="fab fa-facebook"></i> Facebook</a>
          </p>
          <p>
            <a href="https://www.instagram.com/iklasmobileservice"
        ...
        <div class="details">
          ...
          <p>
            We provide you book reviews  <br />
          Happy Reading !
          </p>
          <h4 class="mobile">Mobile</h4>
          <p><a href="#">+91-9334782926</a></p>
          <h4 class="mail">Email</h4>
          <p><a href="#">Bookify@gmail.com</a></p>
        </div>
        <footer>
        <hr />
        © 2022 Bookify.
